...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__panel_app_vue__ = __webpack_require__(6);
/**
...
const router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({ routes: __WEBPACK_IMPORTED_MODULE_2__routes___default.a });

// 实例化 Vue 对象 并将路由挂载到 Vue 实例当中
const app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  router,
  render: h => h(__WEBPACK_IMPORTED_MODULE_3__panel_app_vue__["a" /* default */])
}).$mount('#app');
 ...
 * Created by Administrator on 2017/8/1 0001.
 */
module.exports = [{ path: '/', redirect: '/home' }, { path: '/home', component: resolve => __webpack_require__.e/* require */(3).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(14)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe) }, { path: '/signUp', component: resolve => __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(16)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe) }];
...
var update = __webpack_require__(10)("0f060c2c", content, false);
